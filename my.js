 ...
 * 
 * Этот скрипт реализует динамический калькулятор стоимости услуги,
 * который пересчитывает цену при изменении любых параметров формы.
 * 
 * Основные функции:
 * - Пересчет стоимости при изменении количества
 * - Пересчет при выборе типа услуги
 * - Динамическое отображение/скрытие дополнительных опций
 * - Обработка выбора опций и свойств услуги
 */
